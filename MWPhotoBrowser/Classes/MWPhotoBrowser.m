...
- (void)viewDidLoad {
    ...
    _toolbar.tintColor = SYSTEM_VERSION_GREATER_THAN_OR_EQUAL_TO(@"7") ? _previousNavBarTintColor : nil;
...
- (void)setNavBarAppearance:(BOOL)animated {
    ...
    navBar.tintColor = SYSTEM_VERSION_GREATER_THAN_OR_EQUAL_TO(@"7") ? _previousNavBarTintColor : nil;
